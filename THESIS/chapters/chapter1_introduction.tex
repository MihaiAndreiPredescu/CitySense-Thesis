...
\begin{itemize}
  ...
  \item a fine-tuned YOLOv8n pothole detector integrated into the backend runtime;
  ...
  \item a documented confidence calibration step that reduces false positive reports before database insertion;
