...
\begin{itemize}
  \item collecting and annotating additional classes such as trash piles, damaged signs, and damaged pole-mounted trash bins;
  \item retraining the detector as a multi-class YOLO model and updating the backend label mapping accordingly;
